...
echo qwertydpi - Alternatif Metod 4 (Mod -5 + DNS, TTL olmadan)
...
schtasks /create /tn "qwertydpi" /tr "\"%CD%\%_arch%\goodbyedpi.exe\" -5 --dns-addr 77.88.8.8 --dns-port 1253 --dnsv6-addr 2a02:6b8::feed:0ff --dnsv6-port 1253" /sc ONLOGON /rl HIGHEST /f
